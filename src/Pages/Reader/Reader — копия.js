...
const Read = () => {
    ...
    const fetchChapterHash = async (volume, chapter) => {
        ...
        const currChapter = +chaptersNames[+chapter];

        console.log(chaptersNames);
        console.log(currentChapter);
    ...
    const handleNextImg = () => {
        ...
        if (currentChapter.currImg === currentChapter.maxImg &&
            currentChapter.chapter + 1 <= Object.keys(mangaVolumes[currentChapter.volume]?.chapters).length - 1) {
            setCurrentChapter({
                ...currentChapter,
            ...
            <div className="chapter-content" style={{maxHeight: clientHeight}} onClick={mangaContentDelegate}>
                {
                    ...
                    <div style={{height: '55vh'}}>
                        <Spinner customStyle={{width: '45px', height: '45px'}} />
                    </div>
                }
            </div>
